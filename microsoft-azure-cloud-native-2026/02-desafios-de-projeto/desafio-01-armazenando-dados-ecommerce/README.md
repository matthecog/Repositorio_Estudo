...
- Dados estruturados armazenados em banco relacional
- Imagens e arquivos armazenados em serviço de objetos

Essa abordagem garante maior escalabilidade, organização e facilidade
de manutenção.
